...
from solver.scheduler_factory_stage2 import create_scheduler_stage2
from solver.scheduler_factory_stage3 import create_scheduler_stage3
...
if __name__ == '__main__':
    ...
    train_loader_stage2, train_loader_stage1, val_loader, num_query, num_classes, camera_num, view_num = make_dataloader(
        cfg)
    ...
    if cfg.SOLVER.STAGE2.WARMUP_METHOD == 'cosine':
        logger.info('===========using cosine learning rate=======')
        scheduler_2stage = create_scheduler_stage2(cfg, optimizer_2stage)
    else:
        ...
        scheduler_2stage = WarmupMultiStepLR(optimizer_2stage, cfg.SOLVER.STAGE2.STEPS, cfg.SOLVER.STAGE2.GAMMA,
                                             ...
                                             cfg.SOLVER.STAGE2.WARMUP_EPOCHS, cfg.SOLVER.STAGE2.WARMUP_METHOD)
    ...
    optimizer_3stage = make_optimizer_3stage(cfg, model)
    logger.info('===========using cosine learning rate=======')
    scheduler_3stage = create_scheduler_stage3(cfg, optimizer_3stage)
    do_train_stage3(
        cfg,
        model,
        train_loader_stage2,
