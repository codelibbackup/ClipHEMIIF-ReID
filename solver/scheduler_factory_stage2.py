...
def create_scheduler_stage2(cfg, optimizer):
    num_epochs = cfg.SOLVER.STAGE2.MAX_EPOCHS
    # type 1
    # lr_min = 0.01 * cfg.SOLVER.BASE_LR
    # warmup_lr_init = 0.001 * cfg.SOLVER.BASE_LR
    # type 2
    lr_min = 0.002 * cfg.SOLVER.STAGE2.BASE_LR
    warmup_lr_init = 0.01 * cfg.SOLVER.STAGE2.BASE_LR
    # type 3
