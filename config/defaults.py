...
_C.MODEL.SEMANTIC_WEIGHT = 0.0
_C.MODEL.REDUCE_FEAT_DIM= True
...
# Factor of learning bias
_C.SOLVER.STAGE3.BIAS_LR_FACTOR = 2
# Momentum
...
_C.SOLVER.STAGE3.NUM_HARD_SAMPLER = 4
_C.SOLVER.STAGE3.LAYER = 4
_C.SOLVER.STAGE3.AFN = 'gelu'
_C.SOLVER.STAGE3.RESID_PDROP = 0.1
